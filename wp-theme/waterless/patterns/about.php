...
<div class="wp-block-group main-content ppad">
    ...
    <div class="wp-block-columns grid cols-2">
        ...
        <div class="wp-block-column team-member">
            ...
            <!-- wp:button {"url":"https://meetings-eu1.hubspot.com/jim-skov","text":"Book a meeting","className":"cta","target":"_blank","rel":"noopener noreferrer"} /-->
        </div>
        <!-- /wp:column -->
        ...
        <div class="wp-block-column team-member">
            ...
            <!-- wp:button {"url":"https://meetings-eu1.hubspot.com/paul-yde","text":"Book a meeting","className":"cta","target":"_blank","rel":"noopener noreferrer"} /-->
        </div>
        <!-- /wp:column -->
