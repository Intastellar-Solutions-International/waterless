...
<!-- wp:group {"className":"main-content ppad"} -->
<div class="wp-block-group main-content ppad">

    <!-- wp:columns {"className":"grid cols-2"} -->
    <div class="wp-block-columns grid cols-2">
        ...
        <div class="wp-block-column">
            <figure class="wp-block-image">
                <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/founders/jim.jpg'); ?>" alt="Waterless Scandinavia" />
            </figure>
        </div>
    </div>
    <!-- /wp:columns -->

    <!-- wp:columns {"className":"grid cols-2 ppad"} -->
    <div class="wp-block-columns grid cols-2 ppad">
        <div class="wp-block-column">
            <figure class="wp-block-image">
                <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/founders/team.jpg'); ?>" alt="Waterless Scandinavia Team" />
            </figure>
        </div>
        <div class="wp-block-column">
    ...
    <div class="wp-block-columns grid cols-2">
        ...
        <!-- wp:column {"className":"team-member"} -->
        <div class="wp-block-column team-member">
            <h3>Jim Skov</h3>
            <figure class="wp-block-image">
                <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/founders/jim-skov.jpg'); ?>" alt="Jim Skov" />
            </figure>
            <p>Fyn, Sjælland, Norge og Sverige</p>
            <p>Mail: <a href="mailto:js@waterless.dk">js@waterless.dk</a></p>
            <p>Tel.: +45 30 95 05 59</p>
            <div class="wp-block-buttons">
                <div class="wp-block-button">
                    <a class="wp-block-button__link wp-element-button" href="https://meetings-eu1.hubspot.com/jim-skov" target="_blank" rel="noopener noreferrer">Book a meeting</a>
                </div>
            </div>
        </div>
        <!-- /wp:column -->
        ...
        <div class="wp-block-column team-member">
            <h3>Paúl Knudsen</h3>
            <figure class="wp-block-image">
                <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/founders/paul-knudsen.jpg'); ?>" alt="Paúl Knudsen" />
            </figure>
            <p>Jylland & Nordtyskland</p>
            <p>Mail: <a href="mailto:pk@waterless.dk">pk@waterless.dk</a></p>
            <p>Tel.: +45 20 14 50 84</p>
            <div class="wp-block-buttons">
                <div class="wp-block-button">
                    <a class="wp-block-button__link wp-element-button" href="https://meetings-eu1.hubspot.com/paul-yde" target="_blank" rel="noopener noreferrer">Book a meeting</a>
                </div>
            </div>
        </div>
        <!-- /wp:column -->
